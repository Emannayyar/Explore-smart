...
function EcoInsights() {
    ...
    const [accommodationType, setAccommodationType] = useState('Camping');
                ...
                <div className="eco-layout">
                    ...
                    <div className="eco-form-column">
                        ...
                        <div className="eco-form-group">
                            ...
                            <input type="text" defaultValue="Hunza Valley" className="eco-input" />
                        </div>

                        <div className="eco-form-group">
                            <label><Users size={16} className="text-emerald-500" /> Number of Travelers</label>
                            <input type="number" defaultValue="4" className="eco-input" />
                        ...
                        <button className="btn-calculate-eco">
                            Calculate Eco-Score
                        </button>
                    </div>

                    {/* Right Column: Insights */}
                    <div className="eco-insights-column">
